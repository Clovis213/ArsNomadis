...
void addPoints(void){
  ...
  Point *point1 = new Point(48.11113, -1.64609, 10, 0, "POINT1PONT.WAV", true, "BOUCLE1.WAV");
  listePoints.add(point1);

  Point *point2 = new Point(48.11008, -1.65226, 10, 0, "POINT2ESCALIERS.WAV", true, "BOUCLE2.WAV");
  listePoints.add(point2);

  Point *point3 = new Point(48.10981, -1.65271, 10, 0, "POINT3VERTUGADIN.WAV", true, "BOUCLE3.WAV");
  listePoints.add(point3);

  Point *point4 = new Point(48.10925, -1.65154, 10, 0, "POINT4FINPASSERELLE.WAV", true, "BOUCLE4.WAV");
  listePoints.add(point4);

  Point *point5 = new Point(48.10878, -1.65129, 10, 0, "POINT5JEUX.WAV", true, "BOUCLE5.WAV");
  listePoints.add(point5);

  Point *point6 = new Point(48.110080, -1.649258, 10, 0, "POINT6TRANSATS.WAV", true, "BOUCLE6.WAV");
  listePoints.add(point6);

  Point *point7 = new Point(48.1098904498955, -1.6474908649306026, 10, 0, "POINT7ENTREEGRILLEBLANCHE", true, "BOUCLE7.WAV");
  listePoints.add(point7);

  Point *point8 = new Point(48.10892, -1.64726, 10, 0, "POINT8BANCSIRENE.WAV", true, "BOUCLE8.WAV");
  listePoints.add(point8);

  Point *point9 = new Point(48.10866105086073, -1.6478668663480567, 10, 0, "POINT9DERNIERCROISEMENT.WAV", false, "");
  listePoints.add(point9);
}
...
void checkPosition(void){
  if(listePoints.size()>0){
    ...
    for(int i=0; i<listePoints.size(); i++){
      ...
      if(playingPoint==i && playSdWav1.isPlaying()==false && actualPoint->isLoopTrigger==true){
        if(LOG){
